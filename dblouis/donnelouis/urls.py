...
urlpatterns = [
    ...
    path('api/article/<int:article_id>/like/get/', views_new_features.get_article_likes, name='get_article_likes'),
    ...
    # Popular Content
    path('api/popular/articles/', views_new_features.get_popular_articles, name='get_popular_articles'),
    path('api/popular/forum-sujets/', views_new_features.get_popular_forum_sujets, name='get_popular_forum_sujets'),
]
